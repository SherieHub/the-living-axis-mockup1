...
export function Home() {
  usePageMeta(
    "The Living Axis | Premium Mobile Massage Therapy in Brooklyn, NY",
    "Clinical touch and human understanding. The Living Axis provides personalized mobile therapeutic bodywork and recovery services delivered directly to your space in Brooklyn and greater NYC."
  );
  ...
  return (
    <div className="bg-brand-ivory min-h-screen selection:bg-brand-teal/20 selection:text-brand-espresso">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center relative z-10">
            ...
            >
              ...
              <h1 className="font-display text-[48px] sm:text-[56px] lg:text-[64px] leading-[1.05] text-brand-ivory mb-8">
                Clinical Touch.<br />Human Understanding.
              </h1>
              
              <p className="text-lg md:text-[20px] font-light text-brand-ivory/80 leading-relaxed mb-12 max-w-xl">
                Personalized mobile therapeutic bodywork centered on recovery, mobility, and nervous-system care. Intentional hands-on treatment, delivered directly to the sanctuary of your own space.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                ...
                >
                  Explore Services <ArrowRight size={16} className="transform group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
            </motion.div>
            ...
            >
              <div className="relative transform lg:translate-x-8 lg:translate-y-12">
                <ImagePlaceholder 
                  label="Practitioner or Treatment — 4:5 Photography Placeholder" 
                  aspectRatio="4:5"
      ...
      <section className="py-24 md:py-32 px-6 lg:px-12 max-w-[1440px] mx-auto">
        ...
        >
          <span className="text-brand-teal uppercase tracking-widest text-xs font-semibold mb-6 block">Who This Is For</span>
          <h2 className="text-[36px] md:text-[56px] leading-[1.1] text-brand-teal max-w-3xl">
            Find Your Treatment.
          </h2>
        </motion.div>
        ...
        <div className="flex flex-col gap-12 md:gap-24">
          {[
            ...
            >
              <div className={`md:col-span-10 lg:col-span-8 ${idx % 2 === 0 ? 'md:col-start-1 lg:col-start-2' : 'md:col-start-3 lg:col-start-4'}`}>
                ...
                <p className="text-brand-espresso/70 text-lg leading-relaxed mb-8">
                  {card.need}
                </p>
                <Link to={card.link} className="inline-flex items-center gap-2 text-sm uppercase tracking-widest font-semibold text-brand-teal hover:text-brand-tealHover group transition-colors">
                  Guidance & Treatment <ArrowRight size={16} className="transform group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
            </motion.div>
          ))}
      ...
      <section className="bg-brand-teal/5 py-24 md:py-32 px-6 lg:px-12">
        <div className="max-w-[1440px] mx-auto">
          ...
          >
            <div>
              <span className="text-brand-teal uppercase tracking-widest text-xs font-semibold mb-6 block">Services & Pricing</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {services.map((service, i) => (
              ...
              >
                ...
                <p className="text-brand-espresso/70 mb-8 flex-grow">
                  {service.description}
                </p>
      ...
      <section className="py-24 md:py-32 px-6 lg:px-12 max-w-[1440px] mx-auto">
        ...
        >
          <span className="text-brand-teal uppercase tracking-widest text-xs font-semibold mb-6 block">What to Expect</span>
          <h2 className="text-[36px] md:text-[56px] leading-[1.1] text-brand-teal">
        ...
        <div className="mb-20">
          <ImagePlaceholder 
            label="Mobile Setup — 16:9 or Ultra-Wide Photography Placeholder" 
            aspectRatio="16:9" 
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          {[
            { num: "01", title: "Book", desc: "Select your service and time online. We confirm and send a brief intake." },
            { num: "02", title: "Brief Intake", desc: "We review your needs, current physical state, and any specific goals." },
            { num: "03", title: "Arrival & Setup", desc: "We arrive early to discreetly transform your space into a professional clinic." },
            { num: "04", title: "Your Session", desc: "Completely customized, uninterrupted therapeutic care in your own home." }
          ].map((step, idx) => (
            <motion.div 
              key={idx}
              initial="hidden"
      ...
      <section className="bg-brand-espresso text-brand-ivory py-24 md:py-40 px-6 lg:px-12">
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
            ...
            >
              <ImagePlaceholder 
                label="Practitioner Portrait — 4:5 Photography Placeholder" 
                aspectRatio="4:5"
                dark
                className="border border-brand-ivory/10"
              />
            </motion.div>
            ...
            >
              <span className="text-brand-ivory/60 uppercase tracking-widest text-xs font-semibold mb-6 block">About</span>
              <h2 className="font-display text-[36px] md:text-[56px] leading-[1.1] mb-10">
                Individualized,<br />unhurried care.
              </h2>
              <div className="space-y-6 text-lg md:text-xl text-brand-ivory/80 font-light leading-relaxed mb-12">
                <p>
                  The Living Axis was founded to bridge the gap between high-level clinical therapy and the profound comfort of receiving care in your own environment.
                </p>
                <p>
                  Every body tells a story of its habits, stresses, and histories. Rather than forcing a rote routine, each session is uniquely constructed around what your tissues and nervous system require today. 
                </p>
              </div>
              ...
              <div className="border-l border-brand-eucalyptus/30 pl-8 mb-12">
                <p className="font-display italic text-2xl md:text-3xl text-brand-ivory leading-relaxed mb-4">
                  "True recovery begins the moment the nervous system realizes it is entirely safe and doesn't need to rush."
                </p>
              </div>
      ...
      <section className="py-24 md:py-32 px-6 lg:px-12 bg-brand-ivory max-w-[1440px] mx-auto">
        ...
        >
          <span className="text-brand-teal uppercase tracking-widest text-xs font-semibold mb-6 block">The Experience</span>
        </motion.div>
        ...
        <div className="max-w-[1000px] mx-auto text-center">
          ...
          >
            <h2 className="font-display text-[40px] md:text-[64px] leading-[1.05] text-brand-teal mb-16">
              Brooklyn first.<br />Greater NYC by arrangement.
            </h2>
            ...
            <p className="text-lg text-brand-espresso/70 max-w-2xl mx-auto leading-relaxed">
              Our primary service area covers Brooklyn without additional fees. Travel to other boroughs, Long Island, and select New Jersey locations is frequently arranged with a transparent, distance-based travel fee.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 px-6 lg:px-12 max-w-[1000px] mx-auto">
        ...
        >
          ...
          <Link to="/faq" className="inline-flex items-center gap-2 text-sm uppercase tracking-widest font-semibold text-brand-teal hover:text-brand-tealHover group transition-colors">
            View All FAQs & Policies <ArrowRight size={16} className="transform group-hover:translate-x-1 transition-transform" />
          </Link>
        </motion.div>
        ...
        <div className="border-t border-brand-teal/20">
          {homeFaqs.map((faq, index) => (
            <div key={index} className="border-b border-brand-teal/20">
              ...
              >
                <h3 className="text-xl md:text-2xl font-display text-brand-espresso pr-8">
                  {faq.question}
                </h3>
