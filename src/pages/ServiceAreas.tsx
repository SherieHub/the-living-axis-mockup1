...
export function ServiceAreas() {
  usePageMeta(
    "Service Areas | The Living Axis",
    "Brooklyn first. Greater NYC by arrangement. Premium mobile massage therapy delivered to your space."
  );
  ...
  return (
    <div className="bg-brand-ivory min-h-screen pt-32 pb-0">
      ...
      <section className="px-6 lg:px-12 max-w-[1440px] mx-auto mb-20 md:mb-32">
        ...
        >
          ...
          <p className="text-xl text-brand-espresso/70 font-light leading-relaxed max-w-2xl">
            The Living Axis is exclusively a mobile massage and wellness service. Appointments take place in the comfort of your home, hotel, or appropriate private space. We do not operate a permanent public storefront.
          </p>
        </motion.div>
      </section>
      ...
      <section className="px-6 lg:px-12 max-w-[1440px] mx-auto mb-24 md:mb-32">
        <div className="border-t border-brand-eucalyptus/30 pt-16 md:pt-24 mb-16 md:mb-24">
          ...
          >
            ...
            <div className="md:w-1/2">
              <h2 className="text-xs uppercase tracking-widest font-semibold text-brand-teal mb-4">Primary Service Area</h2>
              <div className="font-display text-[72px] md:text-[100px] leading-none text-brand-teal mb-6">
                Brooklyn
              </div>
              <p className="text-lg text-brand-espresso/70">
                Our core service area covers Brooklyn, where standard travel and mobile setup are fully included in all listed pricing.
              </p>
            </div>
            
            {/* Additional Areas Grid */}
            <div className="md:w-1/2 md:border-l border-brand-eucalyptus/30 md:pl-16">
              <h2 className="text-xs uppercase tracking-widest font-semibold text-brand-teal mb-8">Additional Locations</h2>
        ...
        >
          <ImagePlaceholder 
            label="New York City / Mobile Lifestyle — 21:9 Ultra-Wide Photography Placeholder" 
            aspectRatio="16:9" 
      ...
      <section className="bg-brand-teal/5 py-24 px-6 lg:px-12 border-t border-brand-teal/10">
        <div className="max-w-[1000px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
            ...
            >
              ...
              <p className="text-brand-espresso/80 leading-relaxed mb-6">
                Standard travel time, transportation, and full mobile setup are completely included in all listed pricing for appointments within our normal Brooklyn service area.
              </p>
              <p className="text-brand-espresso/80 leading-relaxed">
                Appointments requiring significantly greater travel time, tolls, or distance outside our core area may require an extended travel fee or a custom quote.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-brand-espresso/60 text-sm leading-relaxed mb-4">
                We recognize that receiving massage at home isn't always possible. When a client cannot or prefers not to receive care in their own space, a private treatment space may occasionally be arranged in advance, subject to availability.
              </p>
              <p className="text-brand-espresso/60 text-sm leading-relaxed">
                Please note that the total service cost will increase accordingly to cover the rental of the clinical space.
              </p>
            </motion.div>
          ...
          >
            <p className="font-display italic text-2xl text-brand-espresso/80 mb-6">
      ...
      <section className="bg-brand-teal text-brand-ivory py-24 md:py-32 px-6 lg:px-12 text-center">
        ...
        >
          <h2 className="font-display text-[40px] md:text-[56px] leading-tight mb-12">
