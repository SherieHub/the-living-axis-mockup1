...
export function FindYourTreatment() {
  usePageMeta(
    "Find Your Treatment | The Living Axis",
  ...
  const panels = [
    ...
    },
    {
      ...
      explanation: "Clinical support for those demanding more from their bodies. Treatment emphasizes muscular recovery, restoring flexibility and mobility, addressing repetitive-use tension, and providing performance support or vital maintenance between heavy workouts or competitive events.",
    ...
    },
    {
      ...
      explanation: "Expert care adapted meticulously around your comfort and safe positioning. Treatment focuses on easing pregnancy-related muscular tension, improving circulation, facilitating deep relaxation, and providing structural support for critical postpartum physical recovery.",
    ...
    },
    {
      ...
      explanation: "Patient, highly adaptable care emphasizing gentle therapeutic touch. Sessions are customized for comfort, providing mobility support, improving circulation, reducing stiffness, and prioritizing overall relaxation and quality of life in a safe environment.",
    ...
    },
    {
      ...
      explanation: "Intensive therapy tailored for healthcare workers, first responders, drivers, tradespeople, hospitality professionals, and caregivers. We address profound muscular fatigue, overuse injuries, restricted movement, and the specific repetitive work demands that compromise your structural health.",
  ...
  return (
    <div className="bg-brand-ivory min-h-screen pt-32 pb-0">
      ...
      <section className="px-6 lg:px-12 max-w-[1440px] mx-auto mb-24 md:mb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 lg:gap-24 mb-24 md:mb-32">
          {panels.slice(0, 2).map((panel, ) => (
            ...
            >
              <h2 className="font-display text-3xl md:text-4xl text-brand-teal mb-6 group-hover:text-brand-tealHover transition-colors">{panel.title}</h2>
              ...
              <p className="text-brand-espresso/70 text-lg leading-relaxed mb-8 flex-grow">
                {panel.explanation}
              </p>
              ...
              >
                See Recommended Services <ArrowRight size={16} className="transform group-hover:translate-x-1 transition-transform" />
              </Link>
            </motion.div>
          ))}
        </div>
        ...
        >
          <ImagePlaceholder 
            label="Neck/Shoulder or Mobility Treatment Detail — 16:9 Photography Placeholder" 
            aspectRatio="16:9" 
          />
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
          {panels.slice(2, 5).map((panel, ) => (
            <motion.div 
              ...
              className="group flex flex-col h-full"
            >
              <h2 className="font-display text-2xl md:text-3xl text-brand-teal mb-6 group-hover:text-brand-tealHover transition-colors">{panel.title}</h2>
              ...
              <p className="text-brand-espresso/70 text-base leading-relaxed mb-6 flex-grow">
                {panel.explanation}
              </p>
              
              <p className="text-xs font-medium text-brand-espresso/50 uppercase tracking-wider mb-8">
                May support: <br/><span className="text-brand-espresso/80 mt-1 block">{panel.supports}</span>
              </p>
              ...
              <Link 
                ...
                className="inline-flex items-center gap-2 text-sm uppercase tracking-widest font-semibold text-brand-teal hover:text-brand-tealHover transition-colors mt-auto"
              >
                Recommended Services <ArrowRight size={16} className="transform group-hover:translate-x-1 transition-transform" />
              </Link>
            </motion.div>
          ))}
        </div>
      ...
      <section className="bg-brand-teal text-brand-ivory py-24 px-6 lg:px-12 text-center">
        ...
        >
          <h2 className="font-display text-[36px] md:text-[48px] mb-6">
            Not sure where to begin?
          </h2>
          <p className="text-lg text-brand-ivory/80 font-light leading-relaxed mb-10">
            You don't need to have it all figured out. Contact us to describe what you are experiencing, and we will guide you toward the right treatment plan.
          </p>
